...
public class IndexController {
    ...
    @ApiOperation("模糊查询文章")
    public String searchArticle(String title, HttpServletRequest request) {
        List<Article> articles = articleServiceImpl.searchArticle(title);
        // 获取文章热度统计信息
        List<Article> articleList = articleServiceImpl.getHeatArticles();
        request.setAttribute("articles", articles);
        request.setAttribute("articleList", articleList);
        return "client/searchArticle";
    }
